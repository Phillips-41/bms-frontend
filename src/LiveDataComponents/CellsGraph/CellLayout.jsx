...
const CellLayout = ({ cellData, thresholds, siteId, serialNumber }) => {
  ...
  const determineStatus = () => {
    ...
    const {
      ...
      // 4. Charging Status
      return bmsAlarmsDTO?.bankDischargeCycle ? "Discharging" : "Charging";
  };
...
>
  ...
  >
    ...
    />
    <Typography variant="h8" sx={{ color: colors.primary[200] }}>
  ...
  >
    {/* Status Animation */}
    <Box>
       <StatusSVG mode={colors.primary[700]} />
    </Box>

    {/* Content */}
    <Box sx={{ textAlign: 'center', display: 'flex', flexDirection: 'column' }}>
      {cellData.cellVoltage === 65.535 || cellData.cellTemperature === '-255' ? (
        <Box >
          <Box display="flex" justifyContent="space-between">
            <Typography variant="h8" sx={{fontSize: "8px"}}>⚡</Typography>
            <Typography variant="h8" sx={{  fontWeight: 'bold', color:colors.primary[200],fontSize: "9px" }}>
              N/A
            </Typography>
          </Box>
          ...
          <Box display="flex" justifyContent="space-between">
            <Typography variant="h8"  sx={{ fontWeight: 'bold', color:colors.primary[200],fontSize: "9px" }}>sg :</Typography>
            <Typography variant="h8" sx={{ fontWeight: 'bold', color:colors.primary[200],fontSize: "9px" }}>
            N/A
          </Typography>
          </Box>
